...
const SuccessOrderPage = lazy(() => import('../pages/Landing/SuccessOrderPage'));
const OrderListPage = lazy(() => import('../pages/Landing/OrderListPage'));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: 'order/success',
        element: withSuspense(SuccessOrderPage),
      },
      {
        path: 'login',
