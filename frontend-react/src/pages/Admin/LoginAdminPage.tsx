...
function LoginAdminPage() {
  ...
  return (
    <div className='h-screen grid grid-cols-1 md:grid-cols-2'>
      <div className='bg-primary hidden md:flex flex-col justify-between p-8'>
        <div className='flex items-center gap-4'>
          <Gem className='size-7 text-white' />
          <p className='text-white font-bold text-lg'>Emerald Retail</p>
        </div>
        <div className=''></div>
        <p className='text-sm text-white'>&copy;2026. Emerald Retail. All Rights Reserved.</p>
      </div>
      <div className='place-self-center p-8'>
        ...
        <div className='mt-8'>
          <p className='text-center text-primary font-semibold text-xl'>Dashboard Admin</p>
